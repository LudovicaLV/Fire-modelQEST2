...
String[] StringForMain = new String[1];
    StringForMain[0] = " ";
    if (runs == null){
    	SimulatorFire2.main(StringForMain);
    System.out.println("Normal simulation");}
    jj_consume_token(0);
  }

  final public Token ActionChoice() throws ParseException, NumberFormatException, RuntimeException, ParseException {Token type=null, nameAction= null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case KEYWORD_ACTIVE:
...
{if ("" != null) return type;}
      {if ("" != null) return nameAction;}
    throw new Error("Missing return statement in function");
  }

  final public Token BoundChoice() throws ParseException, NumberFormatException, RuntimeException, ParseException {Token bound=null, timeTotal=null, nameAgent, actionName=null, actionValue=null, x=null,y=null,z=null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case KEYWORD_TIME:
...
{if ("" != null) return bound;}
    throw new Error("Missing return statement in function");
  }

  final public Token BoundaryOptions() throws ParseException, NumberFormatException, RuntimeException, ParseException {Token name=null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
